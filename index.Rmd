...
The long-term stable janitor version 1.0.0 is now on CRAN! <i class="fa fa-space-shuttle" aria-hidden="true"></i> It has some big improvements that also result in breaking changes.
