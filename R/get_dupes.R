...
#'
#' For hunting duplicate records during data cleaning. Specify the data.frame
#' and the variable combination to search for duplicates and get back the
#' duplicated rows.
#'
#' @param dat The input `data.frame`.
#' @param ... Unquoted variable names to search for duplicates. This takes a
#'   tidyselect specification.
#' @return A data.frame with the full records where the specified
...
#'   If the input data.frame was of class `tbl_df`, the output is as well.
#' @export
#' @examples
